...
class NewsPage extends Page {
    ...
    public function GetNews () {
        ...
        $db = new Db;
        $result = $db -> Select('SELECT * FROM pages WHERE timestamp >= now()-interval 9 month AND category = :category AND active = 1 ORDER BY timestamp DESC', array('category' => $cat_id));
        return $result;
    }
